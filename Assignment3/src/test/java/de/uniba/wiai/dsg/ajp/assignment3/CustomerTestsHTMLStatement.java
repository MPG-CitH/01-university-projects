...
public class CustomerTestsHTMLStatement {

	@BeforeAll
	public static void setup() throws Exception {
		FileCreator.setupHTMLStatement();
	}

	@Test
	public void HTMLStatementFromNormalCustomerWithEmptyRentalList() {

		Customer customer = new Customer("User2");

		String result = customer.htmlStatement();

		String expectedResult = FileCreator.getHTMLWithoutRentalList();

		assertEquals(expectedResult, result,
				"String HTML statement should be correct according to customer data of a normal customer with no movies in rental list.");

	}

	@Test
	public void HTMLStatementFromNormalCustomerWithFilledRentalList() {
		...
		String expectedResult = FileCreator.getHTMLWithRentalList();

		assertEquals(expectedResult, result,
				"String HTML statement should be correct according to customer data of a normal customer with movies in rental list.");

	}

	@Test
	public void HTMLStatementFromPremiumCustomerWithFilledRentalList() {
		...
		String expectedResult = FileCreator.getHTMLWithRentalListPremium();

		assertEquals(expectedResult, result,
				"String HTML statement should be correct according to customer data of a premium customer with movies in rental list.");
	}
